...
public static class NativeMenuBar_AutoGen
{
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Edit/Project Settings", priority = 66)]
    private static void EditProjectSettings()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Edit/Project Settings").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Edit/Project Settings", true, 66)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Edit/Preferences", priority = 67)]
    private static void EditPreferences()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Edit/Preferences").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Edit/Preferences", true, 67)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Lamp", priority = 68)]
    private static void ComponentLamp()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Lamp").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Lamp", true, 68)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/LED", priority = 69)]
    private static void ComponentLED()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/LED").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/LED", true, 69)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Reel", priority = 70)]
    private static void ComponentReel()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Reel").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Reel", true, 70)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Display", priority = 71)]
    private static void ComponentDisplay()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Display").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Display", true, 71)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Button", priority = 72)]
    private static void ComponentButton()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Button").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Button", true, 72)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Screen", priority = 73)]
    private static void ComponentScreen()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Screen").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Screen", true, 73)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Label", priority = 74)]
    private static void ComponentLabel()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Label").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Label", true, 74)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Image", priority = 75)]
    private static void ComponentImage()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Image").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Image", true, 75)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Component/Group", priority = 86)]
    private static void ComponentGroup()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Component/Group").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Component/Group", true, 86)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Start And Load State", priority = 87)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Start And Load State", true, 87)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Save State And Exit", priority = 88)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Save State And Exit", true, 88)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Start", priority = 99)]
    private static void EmulationStart()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Start").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Start", true, 99)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Load State", priority = 100)]
    private static void EmulationLoadState()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Load State").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Load State", true, 100)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Save State", priority = 101)]
    private static void EmulationSaveState()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Save State").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Save State", true, 101)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Exit", priority = 102)]
    private static void EmulationExit()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Exit").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Exit", true, 102)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Pause", priority = 113)]
    private static void EmulationPause()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Pause").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Pause", true, 113)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Resume", priority = 114)]
    private static void EmulationResume()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Resume").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Resume", true, 114)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Throttle", priority = 125)]
    private static void EmulationThrottle()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Throttle").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Throttle", true, 125)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Unthrottle", priority = 126)]
    private static void EmulationUnthrottle()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Unthrottle").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Unthrottle", true, 126)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Soft Reset", priority = 137)]
    private static void EmulationSoftReset()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Soft Reset").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Soft Reset", true, 137)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Hard Reset", priority = 138)]
    private static void EmulationHardReset()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Emulation/Hard Reset").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Emulation/Hard Reset", true, 138)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/MFME/Extract Layout", priority = 139)]
    private static void MFMEExtractLayout()
    {
        menubar.MenuItems.Single(item => item.FullPath == "MFME/Extract Layout").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/MFME/Extract Layout", true, 139)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/MFME/Remap MPU4 Lamps", priority = 140)]
    private static void MFMERemapMPU4Lamps()
    {
        menubar.MenuItems.Single(item => item.FullPath == "MFME/Remap MPU4 Lamps").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/MFME/Remap MPU4 Lamps", true, 140)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/View/Display Text Mode On", priority = 141)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/View/Display Text Mode On", true, 141)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/View/Display Text Mode Off", priority = 142)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/View/Display Text Mode Off", true, 142)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/View/Add MAME View", priority = 153)]
    private static void ViewAddMAMEView()
    {
        menubar.MenuItems.Single(item => item.FullPath == "View/Add MAME View").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/View/Add MAME View", true, 153)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Help/Context Help", priority = 154)]
    private static void HelpContextHelp()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Help/Context Help").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Help/Context Help", true, 154)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Help/Manual", priority = 155)]
    private static void HelpManual()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Help/Manual").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Help/Manual", true, 155)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Help/Check For Updates", priority = 166)]
    private static void HelpCheckForUpdates()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Help/Check For Updates").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Help/Check For Updates", true, 166)]
    ...
    [UnityEditor.MenuItem("NativeMenuBar/Help/About", priority = 177)]
    private static void HelpAbout()
    {
        menubar.MenuItems.Single(item => item.FullPath == "Help/About").Action.Invoke();
    }
    [UnityEditor.MenuItem("NativeMenuBar/Help/About", true, 177)]
