...
{
    public class EditorComponent14SemicolonSegment : EditorComponentSegmentAlpha
    {
...
_material.SetFloat("_SegmentBrightness5",
    GetSegmentBrightness((segmentValue >> 3) & 1, dutyNormalised));
            ...
            // comma tail (4 green)
            //_material.SetFloat("_SegmentBrightness15", GetSegmentBrightness((segmentValue >> 17) & 1));
        }
    }
}
