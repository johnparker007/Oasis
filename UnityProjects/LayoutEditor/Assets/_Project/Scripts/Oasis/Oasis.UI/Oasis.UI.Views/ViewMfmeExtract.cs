...
{
    public class ViewMfmeExtract : ViewBase
    {
        public Panel Panel
        {
            get;
        ...
        protected ViewModelMfmeExtract ViewModelMfmeExtract
        {
            get
            {
                return (ViewModelMfmeExtract)_viewModel;
            }
        }

        public ViewMfmeExtract(RootUI rootUI, Control parent, ViewModel viewModel) : base(rootUI, parent, viewModel)
        {
            BuildMfmeExtractPanel();

            _parent.Controls.Add(Panel);
        }

        private void BuildMfmeExtractPanel()
        {
            ...
            label.Text = "MFME Extract Warning";
