    ...
    public sealed class RuntimeBuildLoaderManifestTests
    {
        ...
        public void MachineRuntimeJsonLoadsFrontSide(string frontSide, RuntimeFaceFrontSide expected, bool expectedInverted)
        {
            ...
            try
            {
                ...
                File.WriteAllText(Path.Combine(root, "machine.runtime.json"), "{\"schema\":\"oasis.machine.runtime\",\"schemaVersion\":4,\"machineId\":\"machine\",\"displayName\":\"machine\",\"runtime\":{\"kind\":\"Emulation\",\"platform\":\"MPU5\",\"platformSettings\":\"{}\"},\"cabinetManifest\":\"cabinet/cabinet.runtime.json\",\"faces\":[{\"faceId\":\"face\",\"assetName\":\"Face\",\"cabinetFaceTargetId\":\"target\",\"frontSide\":\"" + frontSide + "\",\"manifest\":\"faces/Face/face.runtime.json\"}]}");
