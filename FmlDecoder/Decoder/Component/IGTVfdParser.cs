...
{
    internal sealed class IGTVfdParser : ComponentParserBase<IGTVfd>
    {
        private ComponentTagMap componentTagMap = new ComponentTagMap
        {
            { 0x01, new TagInfo(0x04, "DotSize", new byte[] { 0x01 }, ValueRole.UINT32) },
            { 0x02, new TagInfo(0x04, "DotSpacing", new byte[] { 0x02 }, ValueRole.UINT32) },
            { 0x03, new TagInfo(0x04, "OnColour", new byte[] { 0x00, 0xFF, 0x00, 0xFF }, ValueRole.ARGB_COLOR) },
        ...
        public IGTVfd Parse(long componentOffset, uint componentId, byte[] data)
        {
