...
public sealed class OasisPlayerPreviewServiceTests
{
    ...
    public void Preview_BuildFailure_PreventsLaunch()
    {
        ...
        var result = service.Preview(project, "asset.machine", new OasisPlayerPreferences { ExecutablePath = exe }, NoOpEditorProgressReporter.Instance, CancellationToken.None);
    ...
    public void Preview_SuccessfulBuild_PassesExactReturnedBuildRoot()
    {
        ...
        var result = service.Preview(project, "asset.machine", new OasisPlayerPreferences { ExecutablePath = exe, PreviewWidth = 1600, PreviewHeight = 900 }, NoOpEditorProgressReporter.Instance, CancellationToken.None);
