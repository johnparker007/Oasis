...
public sealed class InternalReelOffsetResolverTests
{
    ...
    [InlineData(FruitMachinePlatformType.MaygayM1, 12, -0.045d)]
    [InlineData(FruitMachinePlatformType.MaygayM1, 16, -0.092d)]
    ...
    [InlineData(FruitMachinePlatformType.Scorpion4, 12, 0.587d)]
