...
public sealed class EmulationBackendFactoryTests
{
    ...
    {
        foreach (var platform in Enum.GetValues<FruitMachinePlatformType>().Where(value => value is not FruitMachinePlatformType.None and not FruitMachinePlatformType.Impact and not FruitMachinePlatformType.MPU3 and not FruitMachinePlatformType.MPU5 and not FruitMachinePlatformType.Epoch and not FruitMachinePlatformType.MaygayM1 and not FruitMachinePlatformType.Scorpion4))
