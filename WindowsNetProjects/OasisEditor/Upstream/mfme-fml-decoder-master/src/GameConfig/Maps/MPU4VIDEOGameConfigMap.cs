...
namespace MfmeFmlDecoder.GameConfig.Maps
{
    ...
    internal static class MPU4VIDEOGameConfigMap
    {
        public const string SystemName = "MPU4VIDEO";
            ...
            @"{
              ...
              ""controls"": {
                ...
                ""Screen Brightness"": {
                  ...
                  ""tag"": ""0x9E"",
                  ""encoding"": ""u8"",
                  ""note"": ""UI 0-255; FML stores as replicated RGB COLORREF (e.g. 255=FFFFFFFF, 254=FEFEFEFF). Read low byte.""
                },
                ""Service"": {
                  ""kind"": ""switch-number"",
                  ""storage"": ""fml"",
