...
namespace MfmeFmlDecoder.GameConfig.Maps
{
    ...
    internal static class SYSTEM80GameConfigMap
    {
        public const string SystemName = "SYSTEM80";
            ...
            @"{
              ...
              ""controls"": {
                ...
                ""DIP"": {
                  ...
                  ""note"": ""Image and GAM confirm DIP 1 plus four visible switches from DIP 3.""
                },
                ""EffectsButtons"": {
                  ""kind"": ""checkbox"",
                  ""storage"": ""gam"",
                ...
                ""Output Mappings"": {
                  ...
                  ""note"": ""Each 0x9C port is u16-le: low byte = function type (radio), high byte = form Value. Probed SYSTEM80: navigating ports 0/36/39/46/47/48 matched UI Value to high byte 6/6 (e.g. Reel+Value0=0x000E, LED BCD+Value8=0x0805). Value is often disabled when unused (Reel).""
                },
                ""Rating"": {
                  ""kind"": ""text"",
                  ""storage"": ""gam"",
