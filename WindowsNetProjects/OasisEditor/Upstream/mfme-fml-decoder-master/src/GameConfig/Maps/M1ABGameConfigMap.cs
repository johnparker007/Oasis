...
namespace MfmeFmlDecoder.GameConfig.Maps
{
    ...
    internal static class M1ABGameConfigMap
    {
        public const string SystemName = "M1AB";
            ...
            @"{
              ...
              ""controls"": {
                ...
                ""Sample Clock Rate"": {
                  ...
                  ""tag"": ""0xA3"",
                  ""encoding"": ""u32-le"",
                  ""note"": ""Tag confirmed by matching virgin UI value 128000; edited value did not persist on save in this sample""
                },
                ""Service"": {
                  ""kind"": ""switch-number"",
                  ""storage"": ""fml"",
