...
namespace MfmeFmlDecoder.GameConfig.Maps
{
    ...
    internal static class EPOCHGameConfigMap
    {
        public const string SystemName = "EPOCH";
            ...
            @"{
              ...
              ""controls"": {
                ...
                ""Stake / Prize"": {
                  ...
                  ""unresolvedOptions"": ""Coin Controls / Coin Controls II / Universal II probes incomplete""
                },
                ""Tags"": {
                  ""kind"": ""text"",
                  ""storage"": ""gam"",
