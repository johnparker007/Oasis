...
{
    internal sealed class ProconnMatrixParser : ComponentParserBase<ProconnMatrix>
    {
        private ComponentTagMap componentTagMap = new ComponentTagMap
        {
            { 0x01, new TagInfo(0x04, "Size", new byte[] { 0x03 }, ValueRole.UINT32) },
            { 0x03, new TagInfo(0x04, "OffColour", new byte[] { 0x00, 0x00, 0x00, 0xFF }, ValueRole.ARGB_COLOR) },
            { 0x02, new TagInfo(0x04, "OnColour", new byte[] { 0x00, 0xFF, 0x00, 0xFF }, ValueRole.ARGB_COLOR) },
        ...
        public ProconnMatrix Parse(long componentOffset, uint componentId, byte[] data)
        {
