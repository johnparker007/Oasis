...
namespace MfmeFmlDecoder.src.Decoder.Component
{
    internal sealed class DiscReelParser : ComponentParserBase<DiscReel>
    {
        private ComponentTagMap componentTagMap = new ComponentTagMap
        {
            ...
            { 0x06, new TagInfo(0x04, "Unknown 0x06", new byte[] { 0x00, 0x00, 0x00, 0x00 }, ValueRole.UINT32) },
            ...
            { 0x07, new TagInfo(0x04, "LampPositionsOffset", new byte[] { 0x00, 0x00, 0x00, 0x00 }, ValueRole.INT32) },
            { 0x9A, new TagInfo(0x01, "LampPositionsGapEnabled", new byte[] { 0x00 }, ValueRole.BOOLEAN) },
            { 0x9B, new TagInfo(0x04, "LampPositionsGap", new byte[] { 0x00, 0x00, 0x00, 0x00 }, ValueRole.INT32) },
