...
uint8 mc68000::m68ki_shift_8_table[65] =
{
...
uint16 mc68000::m68ki_shift_16_table[65] =
{
...
uint mc68000::m68ki_shift_32_table[65] =
{
...
static void default_instr_hook_callback(int cycles)
{
}
...
/*
unsigned int mc68000::m68k_get_reg(void* context, m68k_register_t regnum)
{
...
void mc68000::m68k_set_reg(m68k_register_t regnum, unsigned int value)
{
	switch(regnum)
	{
...
void mc68000::m68k_set_bkpt_ack_callback(void  (*callback)(unsigned int data))
{
...
void mc68000::m68k_set_pc_changed_callback(void  (*callback)(unsigned int new_pc))
{
	CALLBACK_PC_CHANGED = callback ? callback : default_pc_changed_callback;
}

void mc68000::m68k_set_fc_callback(void  (*callback)(unsigned int new_fc))
{
	CALLBACK_SET_FC = callback ? callback : default_set_fc_callback;
}

void mc68000::m68k_set_instr_hook_callback(void  (*callback)(int cycles))
{
...
#include <stdio.h>
/* Set the CPU type. */
void mc68000::m68k_set_cpu_type(unsigned int cpu_type)
{
	switch(cpu_type)
	{
...
int mc68000::m68k_execute(int num_cycles)
{
	int lastCycles = num_cycles;
	...
	if(!CPU_STOPPED)
	{
		...
		do
		{
			...
			/* Trace mc68000::m68k_exception, if necessary */
			m68ki_exception_if_trace(); /* auto-disable (see m68kcpu.h) */

			/* Call external hook to peek at CPU */
			m68ki_instr_hook((lastCycles - GET_CYCLES())); /* auto-disable (see m68kcpu.h) */

			lastCycles = GET_CYCLES();
		} while(GET_CYCLES() > 0);
...
int mc68000::m68k_cycles_run(void)
{
	return m68ki_initial_cycles - GET_CYCLES();
}

int mc68000::m68k_cycles_remaining(void)
{
	return GET_CYCLES();
}

/* Change the timeslice */
void mc68000::m68k_modify_timeslice(int cycles)
{
...
void mc68000::m68k_end_timeslice(void)
{
 ...
 */
void mc68000::m68k_set_irq(unsigned int int_level)
{
...
void mc68000::m68k_pulse_reset(void)
{
	...
	{
		memset(&m68ki_cpu, 0x00, sizeof(m68ki_cpu));
		m68ki_build_opcode_table();
		mc68000::m68k_set_int_ack_callback(NULL);
		mc68000::m68k_set_bkpt_ack_callback(NULL);
		mc68000::m68k_set_reset_instr_callback(NULL);
		mc68000::m68k_set_pc_changed_callback(NULL);
		mc68000::m68k_set_fc_callback(NULL);
		mc68000::m68k_set_instr_hook_callback(NULL);
	...
	if(CPU_TYPE == 0)	/* KW 990319 */
		mc68000::m68k_set_cpu_type(M68K_CPU_TYPE_68000);
...
unsigned int mc68000::m68k_context_size()
{
	return sizeof(m68ki_cpu_core);
}

unsigned int mc68000::m68k_get_context(void* dst)
{
 ...
 */
uint mc68000::m68ki_get_ea_pcdi(void)
{
	uint old_pc = REG_PC;
 ...
 * 1  100-111  reserved
 */
uint mc68000::m68ki_get_ea_ix(uint An)
{
	/* An = base register */
...
/* Fetch operands */
uint mc68000::OPER_AY_AI_8(void)  {uint ea = EA_AY_AI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AY_AI_16(void) {uint ea = EA_AY_AI_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AY_AI_32(void) {uint ea = EA_AY_AI_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AY_PI_8(void)  {uint ea = EA_AY_PI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AY_PI_16(void) {uint ea = EA_AY_PI_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AY_PI_32(void) {uint ea = EA_AY_PI_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AY_PD_8(void)  {uint ea = EA_AY_PD_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AY_PD_16(void) {uint ea = EA_AY_PD_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AY_PD_32(void) {uint ea = EA_AY_PD_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AY_DI_8(void)  {uint ea = EA_AY_DI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AY_DI_16(void) {uint ea = EA_AY_DI_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AY_DI_32(void) {uint ea = EA_AY_DI_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AY_IX_8(void)  {uint ea = EA_AY_IX_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AY_IX_16(void) {uint ea = EA_AY_IX_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AY_IX_32(void) {uint ea = EA_AY_IX_32(); return m68ki_read_32(ea);}

uint mc68000::OPER_AX_AI_8(void)  {uint ea = EA_AX_AI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AX_AI_16(void) {uint ea = EA_AX_AI_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AX_AI_32(void) {uint ea = EA_AX_AI_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AX_PI_8(void)  {uint ea = EA_AX_PI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AX_PI_16(void) {uint ea = EA_AX_PI_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AX_PI_32(void) {uint ea = EA_AX_PI_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AX_PD_8(void)  {uint ea = EA_AX_PD_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AX_PD_16(void) {uint ea = EA_AX_PD_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AX_PD_32(void) {uint ea = EA_AX_PD_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AX_DI_8(void)  {uint ea = EA_AX_DI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AX_DI_16(void) {uint ea = EA_AX_DI_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AX_DI_32(void) {uint ea = EA_AX_DI_32(); return m68ki_read_32(ea);}
uint mc68000::OPER_AX_IX_8(void)  {uint ea = EA_AX_IX_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_AX_IX_16(void) {uint ea = EA_AX_IX_16(); return m68ki_read_16(ea);}
uint mc68000::OPER_AX_IX_32(void) {uint ea = EA_AX_IX_32(); return m68ki_read_32(ea);}

uint mc68000::OPER_A7_PI_8(void)  {uint ea = EA_A7_PI_8();  return m68ki_read_8(ea); }
uint mc68000::OPER_A7_PD_8(void)  {uint ea = EA_A7_PD_8();  return m68ki_read_8(ea); }

uint mc68000::OPER_AW_8(void)     {uint ea = EA_AW_8();     return m68ki_read_8(ea); }
uint mc68000::OPER_AW_16(void)    {uint ea = EA_AW_16();    return m68ki_read_16(ea);}
uint mc68000::OPER_AW_32(void)    {uint ea = EA_AW_32();    return m68ki_read_32(ea);}
uint mc68000::OPER_AL_8(void)     {uint ea = EA_AL_8();     return m68ki_read_8(ea); }
uint mc68000::OPER_AL_16(void)    {uint ea = EA_AL_16();    return m68ki_read_16(ea);}
uint mc68000::OPER_AL_32(void)    {uint ea = EA_AL_32();    return m68ki_read_32(ea);}
uint mc68000::OPER_PCDI_8(void)   {uint ea = EA_PCDI_8();   return m68ki_read_pcrel_8(ea); }
uint mc68000::OPER_PCDI_16(void)  {uint ea = EA_PCDI_16();  return m68ki_read_pcrel_16(ea);}
uint mc68000::OPER_PCDI_32(void)  {uint ea = EA_PCDI_32();  return m68ki_read_pcrel_32(ea);}
uint mc68000::OPER_PCIX_8(void)   {uint ea = EA_PCIX_8();   return m68ki_read_pcrel_8(ea); }
uint mc68000::OPER_PCIX_16(void)  {uint ea = EA_PCIX_16();  return m68ki_read_pcrel_16(ea);}
uint mc68000::OPER_PCIX_32(void)  {uint ea = EA_PCIX_32();  return m68ki_read_pcrel_32(ea);}
...
void mc68000::m68ki_push_16(uint value)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP - 2);
	m68ki_write_16(REG_SP, value);
}

void mc68000::m68ki_push_32(uint value)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP - 4);
	m68ki_write_32(REG_SP, value);
}

uint mc68000::m68ki_pull_16(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP + 2);
	return m68ki_read_16(REG_SP-2);
}

uint mc68000::m68ki_pull_32(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP + 4);
 ...
 */
void mc68000::m68ki_fake_push_16(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP - 2);
}

void mc68000::m68ki_fake_push_32(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP - 4);
}

void mc68000::m68ki_fake_pull_16(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP + 2);
}

void mc68000::m68ki_fake_pull_32(void)
{
	REG_SP = MASK_OUT_ABOVE_32(REG_SP + 4);
}
 ...
 * in m68kconf.h.
 */
void mc68000::m68ki_jump(uint new_pc)
{
	REG_PC = new_pc;
	m68ki_pc_changed(REG_PC);
}

void mc68000::m68ki_jump_vector(uint vector)
{
 ...
 * bit branches.
 */
void mc68000::m68ki_branch_8(uint offset)
{
	REG_PC += MAKE_INT_8(offset);
}

void mc68000::m68ki_branch_16(uint offset)
{
	REG_PC += MAKE_INT_16(offset);
}

void mc68000::m68ki_branch_32(uint offset)
{
	REG_PC += offset;
	m68ki_pc_changed(REG_PC);
}
 ...
 */
void mc68000::m68ki_set_s_flag(uint value)
{
 ...
 */
void mc68000::m68ki_set_sm_flag(uint value)
{
	/* Backup the old stack pointer */
	REG_SP_BASE[FLAG_S | ((FLAG_S>>1) & FLAG_M)] = REG_SP;
...
void mc68000::m68ki_set_sr_noint(uint value)
{
...
uint mc68000::m68ki_init_exception(void)
{
...
void mc68000::m68ki_stack_frame_3word(uint pc, uint sr)
{
	m68ki_push_32(pc);
	m68ki_push_16(sr);
}
 ...
 */
void mc68000::m68ki_stack_frame_0000(uint pc, uint sr, uint vector)
{
 ...
 */
void mc68000::m68ki_stack_frame_0001(uint pc, uint sr, uint vector)
{
 ...
 */
void mc68000::m68ki_stack_frame_0010(uint sr, uint vector)
{
 ...
 */
void mc68000::m68ki_stack_frame_buserr(uint pc, uint sr, uint address, uint write, uint instruction, uint fc)
{
	m68ki_push_32(pc);
	m68ki_push_16(sr);
 ...
 */
void mc68000::m68ki_stack_frame_1000(uint pc, uint sr, uint vector)
{
	/* VERSION
	 * NUMBER
 ...
 */
void mc68000::m68ki_stack_frame_1010(uint sr, uint vector, uint pc)
{
	/* INTERNAL REGISTER */
	m68ki_push_16(0);
 ...
 */
void mc68000::m68ki_stack_frame_1011(uint sr, uint vector, uint pc)
{
 ...
 */
void mc68000::m68ki_exception_trap(uint vector)
{
...
void mc68000::m68ki_exception_trapN(uint vector)
{
	uint sr = m68ki_init_exception();
	m68ki_stack_frame_0000(REG_PC, sr, vector);
	m68ki_jump_vector(vector);
...
void mc68000::m68ki_exception_trace(void)
{
	uint sr = m68ki_init_exception();
...
void mc68000::m68ki_exception_privilege_violation(void)
{
	uint sr = m68ki_init_exception();
...
void mc68000::m68ki_exception_1010(void)
{
	uint sr;
...
void mc68000::m68ki_exception_1111(void)
{
	uint sr;
...
void mc68000::m68ki_exception_illegal(void)
{
	uint sr;
	...
	sr = m68ki_init_exception();
	m68ki_stack_frame_0000(REG_PC, sr, EXCEPTION_ILLEGAL_INSTR);
	m68ki_jump_vector(EXCEPTION_ILLEGAL_INSTR);

	/* Use up some clock cycles and undo the instruction's cycles */
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_ILLEGAL_INSTR] - CYC_INSTRUCTION[REG_IR]);
}

/* Exception for format errror in RTE */
void mc68000::m68ki_exception_format_error(void)
{
	uint sr = m68ki_init_exception();
...
void mc68000::m68ki_exception_address_error(void)
{
	/* Not emulated yet */
}
...
void mc68000::m68ki_exception_interrupt(uint int_level)
{
	uint vector;
	uint sr;
	uint new_pc;
